...
$i   = 0;
?>
<div id="pc-notes-wrapper" data-total="<?php echo e($len); ?>">
    <?php foreach ($notes as $note) { ?>
    <div class="media pc-note-wrapper">
        ...
        <div class="media-body">
            ...
            <a href="#" class="pull-right text-danger"
                onclick="delete_pc_note(this,<?php echo e($note['id']); ?>);return false;">
                <i class="fa fa fa-times"></i>
            </a>
            <a href="#" class="pull-right mright5" onclick="toggle_edit_pc_note(<?php echo e($note['id']); ?>);return false;">
            ...
            <div data-note-edit-textarea="<?php echo e($note['id']); ?>" class="hide mtop15">
                ...
                <div class="text-right">
                    <button type="button" class="btn btn-default"
                        onclick="toggle_edit_pc_note(<?php echo e($note['id']); ?>);return false;">
                        <?php echo _l('cancel'); ?>
                    </button>
                    <button type="button" class="btn btn-primary" onclick="edit_pc_note(<?php echo e($note['id']); ?>);">
