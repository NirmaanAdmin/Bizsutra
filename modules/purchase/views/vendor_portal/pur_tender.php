    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="tab-content">
          ...
          <div class="row">
            <div class="col-md-12">
              <a href="<?php echo site_url('purchase/vendors_portal/add_update_quotation?purchase_request='.$pur_tender->id); ?>" class="btn btn-info mbot10 pull-right"><?php echo _l('convert_to_quotation'); ?></a>
            </div>
             ...
             <div class="col-md-6">
                <table class="table table-striped table-bordered">
                  <tr>
                    ...
                    <td><?php echo pur_html_entity_decode($pur_tender->pur_tn_code); ?></td>
                  </tr>
                  <tr>
                    <td><?php echo _l('pur_rq_name'); ?></td>
                    <td><?php echo pur_html_entity_decode($pur_tender->pur_tn_name); ?></td>
                  </tr>
                  <tr>
             ...
             <div class="col-md-6">
                <table class="table table-striped table-bordered">
                  ...
                  <tr>
                    ...
                    <td><?php echo get_staff_full_name($pur_tender->requester); ?></td>
                  </tr>
                  <tr>
                    <td><?php echo _l('status'); ?></td>
                    <td><?php echo get_status_approve($pur_tender->status); ?></td>
                  </tr>
                </table>
             </div>  
        ...
        <div role="tabpanel" class="tab-pane <?php if($this->input->get('tab') === 'attachment'){echo ' active';} ?>" id="attachment">
              <?php echo form_open_multipart(site_url('purchase/vendors_portal/upload_pr_files/'.$pur_tender->id.'/'.$pur_tender->hash),array('class'=>'dropzone','id'=>'files-upload')); ?>
                  ...
                  <td data-order="<?php echo $file['dateadded']; ?>"><?php echo _dt($file['dateadded']); ?></td>
                      ...
                      <td>
                          <?php if($file['contact_id'] == get_vendor_contact_user_id()){ ?>
                              <a href="<?php echo site_url('purchase/vendors_portal/delete_pr_file/'.$file['id'].'/'.$pur_tender->id.'/'.$pur_tender->hash); ?>"
             ...
             <table class="table items items-preview estimate-items-preview" data-type="estimate">
                ...
                <tbody class="ui-sortable">
                   ...
                   foreach($pur_tender_detail as $es) { 
                    ...
                    if (!empty($es['image'])) {
                      $item_base_url = base_url('uploads/purchase/pur_tender/' . $es['pur_tender'] . '/' . $es['tn_id'] . '/' . $es['image']);
